...
async function screenshotOnly(filePath, searchValue, message ) {
  ...
  const prompt =
    message ||
    ` I am  playing ${searchValue} and the image attached shows what's currently on my screen. Based on this,what should I do`;
